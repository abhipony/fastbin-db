CREATE TABLE [dbo].[Bin_Orders_PackingSlip_Dtl_OMS] (
    ...
    CONSTRAINT [Bin_Orders_PackingSlip_Dtl_PK] PRIMARY KEY CLUSTERED ([BIN_ROW] ASC, [BIN_COLUMN] ASC, [SKU] ASC, [BIN_ID] ASC, [PLANOGRAM_ID] ASC)
);
